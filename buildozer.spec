...
# (str) Package name
package.name = marathonapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kensy
...
android.cmdline_tools_path = /mnt/c/Users/k.vodopianov/AppData/Local/Android/Sdk/cmdline-tools/latest
